...
\hrulefill
\begin{itemize}
\item Proficient: Java, JavaScript, Python, Git, REST, Node, SQL
\item Comfortable: C/C++, Lua, LaTeX, C\#, Django, Ansible, MongoDB, Agile, Docker
\item Familiar: Rust, Go, AngularJS, Chef, ReactJS, Kubernetes
\end{itemize}
\smallskip
