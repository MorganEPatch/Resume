...
\hfill
\begin{itemize}
\item Proficient: Java, JavaScript, Python
\item Comfortable: C/C++, Lua, LaTeX, C\#
\item Familiar: Rust, Go
\end{itemize}
\item[Libraries and Technologies]
\hfill
\begin{itemize}
\item Proficient: Git, REST, Node, SQL
\item Comfortable: Django, HAPRoxy, Ansible, Subversion, MongoDB, Agile
\item Familiar: AngularJS, Chef, ReactJS
\end{itemize}
\end{description}
\smallskip
